...
const commands = [{ name: 'Overview', path: '/app' }, { name: 'Projects', path: '/app/projects' }, { name: 'Test Library', path: '/app/test-library' }, { name: 'Test Suites', path: '/app/test-suites' }, { name: 'Test Cases', path: '/app/test-cases' }, { name: 'Runs', path: '/app/runs' }, { name: 'Issues', path: '/app/issues' }, { name: 'Settings — Coming soon' }]
